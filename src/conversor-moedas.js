...
function ConversorMoedas() {
  ...
  const [exibirMsgDeErro, setExibirMsgDeErro] = useState(false);

  //replace para remover dígito não numérico
  ...
  return (
    <div>
      ...
      <Alert variant="danger" show={exibirMsgDeErro}>
